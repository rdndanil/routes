          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="bg-blue-600 dark:bg-blue-700 text-white shadow-lg rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-4 text-white flex items-center">
                ...
                Норматив движения ТС
              </h3>
              <p className="mt-2 text-sm">
                Рассчитайте примерное время ТС в пути, предварительно указав маршрут, дату и время отправления ТС.
              </p>
              <button
                onClick={() => navigate("/normativ")} // Переход на страницу Нормативы
                className="mt-4 bg-white text-blue-600 font-medium py-2 px-4 rounded hover:bg-gray-100"
              >
                Перейти
              </button>
